const typeStrings = (function () {
    const values = {
        strings: ["Hi there, Hello", "Welcome to EcoCyrus", "Contact Me"],
...
typeStrings.values.strings = [...document.querySelector('.typeHere').children].reduce((acc, cur) => {
    acc.push(cur.textContent)
    return acc
}, [])
typeStrings.values.cssSelector = '.typeHere'
